<div id="app-sidepanel" class="app-sidepanel sidepanel-visible">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href=""><img class="logo-icon me-2" src="{{ asset('assets/img/logo.png') }}" alt="logo"><span class="logo-text">Admin</span></a>
        </div>
            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item has-submenu">
                    <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1" aria-expanded="false" aria-controls="submenu-1">
                        ...
                        <span class="nav-link-text">Managemen User</span>
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('admin.view_guru') }}">Guru</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="">Siswa</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="">Input Soal</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="">Cek Nilai</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
